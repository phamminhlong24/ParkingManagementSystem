            ...
            <div class="zone-B-left col-md-12">
                <div class="row">
                    <% for (ParkingSlot parkingSlotB : list1) {
                            String slotNum = parkingSlotB.getParkingSlotNumber();
                    ...
                    <%
                    } else if (parkingSlotB.getParkingSlotStatus() == 1) {
                    %>
                    <div class="col-md-2">
                        <button class="lot-B-detail mr-3 mt-3 bg-warning" data-toggle="modal" data-target="#<%=parkingSlotB.getParkingSlotNumber()%>">
                            <%= parkingSlotB.getParkingSlotNumber()%>
                        </button>
                    </div>
                    <%
                    } else if (parkingSlotB.getParkingSlotStatus() == 3) {
                    %>
                    
                    <div class="col-md-2">
                        <button class="lot-B-detail mr-3 mt-3 bg-info" data-toggle="modal" data-target="#<%=parkingSlotB.getParkingSlotNumber()%>">
                            <%= parkingSlotB.getParkingSlotNumber()%>
                        </button>
                    </div>
                    <%
                    ...
                    <div class="modal fade" id="<%=parkingSlotB.getParkingSlotNumber()%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input
                                                                ...
                                                                value="<%= parkingSlotB.getParkingSlotNumber()%>"
                                                                />
                                                        </div>
                                                        <% if (parkingSlotB.getParkingSlotStatus() != 0) {%>
